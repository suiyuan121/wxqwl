 ...
 * @version $Id: WxDefaultMsgExecutor.java, v 0.1 2016年4月15日 上午11:21:53 {jin.zhang@witontek.com} Exp $
 */
public class WxDefaultMsgExecutor implements WxMsgExecutor {

    private static final Logger logger = LoggerFactory.getLogger(WxDefaultMsgExecutor.class);
