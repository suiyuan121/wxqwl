	...
	Window.prototype = $.extend({},new Widget(),{           //继承widget类
						renderUI:function(){
							...
							switch(this.cfg.winType){
								case 'alert':
								      ...
								      break;
								case 'confirm':
								     footContent = '<input type="button" value="'+this.cfg.text4CancelBtn+'" class="window_cancelBtn"><input type="button" value="'+this.cfg.text4ConfirmBtn+'" class="emng-btn btn-bg-blue window_confirmBtn">';
								     break;
								case 'prompt':   
								     ...
								     footContent = '<input type="button" value="' + this.cfg.text4CancelBtn + '" class="window_cancelBtn"><input type="button" value="'+this.cfg.text4PromptBtn+'" class="emng-btn btn-bg-blue window_promptBtn">';
								     break;
							};
						...
						bindUI:function(){
							...
							this.boundingBox.delegate('.window_alertBtn','click',function(){
								...
								if(that.cfg.testRules && that.cfg.testRules(that._promptInput.val())){
