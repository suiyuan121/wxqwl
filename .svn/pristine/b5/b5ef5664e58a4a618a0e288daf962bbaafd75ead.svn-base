...
public class WeiXinUserRepositoryImpl implements WeiXinUserRepository {
    ...
    @Override
    public boolean updateSubscribeByOpenId(WeiXinUserDo weiXinUserDo) {
        logger.info("更新订阅状态   weiXinUserDo={}", weiXinUserDo);
        return weiXinUserDao.updateSubscribeByOpenId(weiXinUserDo.getSubscribe(),
            weiXinUserDo.getOpenId());
    }
}
