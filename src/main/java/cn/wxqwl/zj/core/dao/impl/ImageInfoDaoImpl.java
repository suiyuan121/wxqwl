 ...
 * @version $Id: ImageInfoDaoImpl.java, v 0.1 2016年9月1日 下午3:24:14 Administrator
 *          Exp $
 */
public class ImageInfoDaoImpl extends SqlSessionDaoSupport implements
		ImageInfoDao {

	private static final Logger logger = LoggerFactory
			.getLogger(ImageInfoDaoImpl.class);
