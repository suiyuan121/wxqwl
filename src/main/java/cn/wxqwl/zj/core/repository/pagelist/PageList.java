package cn.wxqwl.zj.core.repository.pagelist;
...
public class PageList<T> extends BaseModel {
	...
	/**  */
	private static final long serialVersionUID = -5409094348162554823L;
	 ...
	 * 
	 * @param resultList
	 *            value to be assigned to property resultList
	 */
